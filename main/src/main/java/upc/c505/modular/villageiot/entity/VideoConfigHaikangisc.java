...
@TableName("video_config_haikangISC")
@ApiModel(value = "VideoConfigHaikangisc对象", description = "")
public class VideoConfigHaikangisc implements Serializable {

    private static final long serialVersionUID = 1L;

    @ApiModelProperty("海康视频配置表的id")
