...
public class EcoChainAnalyticalOverviewReturnParamOne {
    ...
    private List<EcoChainDataStatisticsNameValuePairParam> hourlyVisitorCounts;

    @ApiModelProperty("每天累计访客数")
    private List<EcoChainDataStatisticsNameValuePairParam> dailyVisitorCounts;
}
