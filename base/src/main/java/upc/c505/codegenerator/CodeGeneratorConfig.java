package upc.c505.codegenerator;
...
public class CodeGeneratorConfig {
    ...
    /**
     * 模块名，目前有main和base两个模块？咋的，auth不算啊
     */
...
//        String url = "jdbc:mysql://27.223.88.150:10003/new_restructure";
        String url = "jdbc:mysql://13.13.60.105/future_village";
        String username = "root";
        String password = "Qiaolian@888";
        ...
        FastAutoGenerator.create(url, username, password)
                ...
                .packageConfig(builder -> {
                    // 设置父包名
                    builder.parent("upc.c505.modular.ecochain")
