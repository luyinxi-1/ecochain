...
public class FunctionAuthNode {
    ...
    public void getChildrenNode(List<SysAuthModel> sysAuthModels, ConcurrentMap<Long, List<FunctionAuthNode>> concurrentMap) {
        for (SysAuthModel authModel : sysAuthModels) {
            //找到子节点
